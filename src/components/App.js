  ...
  render(){
    return (
      <div className="App">
        <Header/>
        <div id="projects">
          <Project styleType="ProjectFullW" title="Mordecai Marches To Manchuria" modalNum="0" imageLink="https://raw.githubusercontent.com/fasky/Images/master/MordechiTitle.PNG" secondImage="https://raw.githubusercontent.com/fasky/Images/master/MordechiMap.PNG" description="<a target='_blank' href='https://mordechi-fasky.herokuapp.com/'>Link (may take a moment to spin up on Heroku, lost access to diary iamges)</a> - Re-engineering and modernizing a history site using React, JS, GraphQL, Node.js, and Airtable. Full-stack, remote. Database work, research, server development, front-end development."/>
